    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                ...
                if (val < 1.0) {
                    // first button
                    if (virtualbutton_hm.indexOfValue(
                            HardCodeWrapper.
                            KEYCODE_VIRTUAL_A
                        ) > 0) {
                        return false;
                    ...
                    evt =
                        new KeyEvent(action, HardCodeWrapper.KEYCODE_VIRTUAL_A);
                    virtualbutton_hm.put(
                        pId,
                        HardCodeWrapper.KEYCODE_VIRTUAL_A
                    );
                    ...
                    evt =
                        new KeyEvent(action, HardCodeWrapper.KEYCODE_VIRTUAL_B);
                    virtualbutton_hm.put(
                        pId,
                        HardCodeWrapper.KEYCODE_VIRTUAL_B
                    );
                    ...
                    evt =
                        new KeyEvent(action, HardCodeWrapper.KEYCODE_VIRTUAL_C);
                    virtualbutton_hm.put(
                        pId,
                        HardCodeWrapper.KEYCODE_VIRTUAL_C
                    );
                    ...
                    evt =
                        new KeyEvent(action, HardCodeWrapper.KEYCODE_VIRTUAL_D);
                    virtualbutton_hm.put(
                        pId,
                        HardCodeWrapper.KEYCODE_VIRTUAL_D
                    );
